...
$(document).ready(function(){
	...
	$("#idButton").click(function(){
		...
		if(num1==numCheck){
			...
			var name=$("#name").val();
			var tel=$("#tel").val();
			var param="id="+id+"&name="+name+"&tel="+tel;
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath }/getPwdSearchMemberController",
				data:param,
				success:function(data){
					var result=eval("("+data+")");
					alert("고객님의 pwd는: "+result.pwd+" 입니다");
					location.href="${pageContext.request.contextPath }/movie/Main.jsp?sub=loginForm.jsp";
				}	
...
<td><input type="text" border="0" id="id" placeholder="아이디" style="width:99%;height:50px"></td>
<td rowspan="5">
<input type="button" id="idButton" value="아이디찾기" style="background-color:#1E96FF;height:250px">
</tr>
<tr style="height:50px">
